...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        user.setUserName("Lakshmana");
        user.setAge(23);
        user.setMobileNo("8890878907");
        user.setPassword("Laku@2134");
        user.setConfirmPassword("Laku@2134");
...
//        controller.save(user);
        ...
        System.out.println("Controller calling droptable ");
        System.out.println(controller.dropTable());
    }
